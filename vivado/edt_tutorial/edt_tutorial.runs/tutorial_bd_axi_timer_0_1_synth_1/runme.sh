...
HD_PWD='C:/Users/dianhsu/Desktop/FPGA/edt_tutorial/edt_tutorial.runs/tutorial_bd_axi_timer_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tutorial_bd_axi_timer_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tutorial_bd_axi_timer_0_1.tcl
